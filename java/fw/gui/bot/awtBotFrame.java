...
import fw.gui.map.MapSwingRender;
...
public class awtBotFrame extends JPanel implements GameVisualInterface, Runnable {
    ...
    public awtBotFrame(HashMap<String, ServerConfig> srvList,
                       JTabbedPane tabPane, int tind) throws Exception {
        super();
        setSize(1000, 700);
...
//				        _canvas.setScale(scale);
        ...
        spinner.setModel(new SpinnerNumberModel(500, null, null, 25));
    ...
    public void run() {
        ...
        if (_gameEngine.getSelfChar() == null) {
            return;
        }
